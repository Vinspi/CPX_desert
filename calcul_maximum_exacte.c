...
int sommet_degre_min_safe(Graph *g, sous_graphe_max *xs){
...
int main(int argc, char *argv[]){
    ...
    printf("QQ\n");
    loadSource("./Benchs/myciel3", graph);
    printf("Coucou\n");

    //Résultat :
    liste X = calcul_maximum_exact(graph);
